...
use crate::components::icons::{Bug, Cpu, Layout, Smartphone, Wrench, Zap};
...
pub fn features() -> Vec<Feature> {
    vec![
        ...
        Feature {
            icon: || view! { <Wrench class="w-6 h-6 text-amber-400" /> }.into_any(),
            title: "Install Wizard",
            desc: "Sets up Flutter from scratch: diagnoses your toolchain, installs any Flutter version via a built-in version picker, configures the Android SDK and your PATH, and guides everything it can't auto-run. Never runs sudo for you.",
        },
        Feature {
            icon: || view! { <Bug class="w-6 h-6 text-cyan-400" /> }.into_any(),
            title: "DevTools in the Terminal",
            desc: "Widget Inspector, frame timings, memory, and a network monitor — live from the Dart VM Service, without leaving the terminal. Debug overlays toggle with a keystroke.",
        },
    ]
}
