...
pub fn normal_keybindings() -> Vec<Keybinding> {
    vec![
        Keybinding {
            key: "q / Esc",
            action: "Quit",
            description: "Request to quit (may show confirmation)",
        },
        Keybinding {
            key: "r",
            action: "Hot Reload",
            description: "Trigger a hot reload (disabled when busy)",
        },
        Keybinding {
            key: "R",
            action: "Hot Restart",
            description: "Trigger a hot restart (disabled when busy)",
        },
        Keybinding {
            key: "d",
            action: "Open device selector",
            description: "Open the New Session Dialog",
        },
        Keybinding {
            key: "c",
            action: "Clear logs",
            description: "Clear all logs in current session",
        },
        Keybinding {
            key: "1-9",
            action: "Switch Session",
            description: "Switch to session 1-9 directly",
        },
        Keybinding {
            key: "Tab",
            action: "Next Session",
            description: "Cycle to the next session",
        },
        Keybinding {
            key: "j / k",
            action: "Scroll",
        ...
        Keybinding {
            key: "/",
            action: "Search",
            description: "Enter search input mode",
        },
        Keybinding {
            key: "L",
            action: "Link Mode",
            description: "Enter link highlight mode to open files",
        },
    ]
}
...
pub fn dialog_keybindings() -> Vec<Keybinding> {
    vec![
        Keybinding {
            key: "Tab",
            action: "Switch Pane",
            description: "Switch between Target Selector and Launch Context",
        },
        Keybinding {
            key: "Enter",
            action: "Select / Launch",
            description: "Select device or Launch configuration",
        },
        Keybinding {
            key: "\u{2191} / \u{2193}",
            action: "Navigate",
...
pub fn settings_keybindings() -> Vec<Keybinding> {
    vec![
        Keybinding {
            ...
            description: "Open the full-screen settings panel",
        },
        Keybinding {
            key: "Enter",
            action: "Edit Value",
