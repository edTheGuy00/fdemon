...
|---|------|--------|------------|---------|
| 1 | [01-network-cleanup-exit](tasks/01-network-cleanup-exit.md) | Not Started | - | `handler/session.rs` |
| 2 | [02-network-cleanup-appstop](tasks/02-network-cleanup-appstop.md) | Not Started | - | `handler/session.rs` |
| 3 | [03-network-cleanup-tests](tasks/03-network-cleanup-tests.md) | Not Started | 01, 02 | `handler/tests.rs` |
...
| 3 | `handle_session_exited` | `handler/session.rs:95` | ✅ | ❌ **Task 01** |
| 4 | `AppStop` in `handle_session_message_state` | `handler/session.rs:161` | ✅ | ❌ **Task 02** |
...
- [ ] New tests verify both cleanup paths
