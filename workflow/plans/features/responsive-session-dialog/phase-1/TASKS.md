...
|---|------|--------|------------|------------|---------|
| 1 | [01-threshold-constants](tasks/01-threshold-constants.md) | Done | - | 1h | `mod.rs` |
| 2 | [02-render-panes-compact-arg](tasks/02-render-panes-compact-arg.md) | Done | - | 1-2h | `mod.rs` |
| 3 | [03-horizontal-height-decision](tasks/03-horizontal-height-decision.md) | Done | 1, 2 | 2-3h | `mod.rs` |
| 4 | [04-vertical-height-decision](tasks/04-vertical-height-decision.md) | Done | 1 | 2-3h | `mod.rs` |
| 5 | [05-unit-tests](tasks/05-unit-tests.md) | Done | 3, 4 | 2-3h | `mod.rs`, `target_selector.rs`, `launch_context.rs` |

## Success Criteria

Phase 1 is complete when:

- [x] Narrow-but-tall terminal (e.g., 50x40) shows expanded Launch Context fields
- [x] Wide-but-short terminal (e.g., 100x25) shows compact Launch Context fields
- [x] Existing horizontal/vertical layout switching still works correctly at standard sizes
- [x] Hysteresis constants defined (stateless decision for now, refinement deferred)
- [x] All existing tests pass (`cargo test -p fdemon-tui`) — 782 tests, 0 failures
- [x] New unit tests cover height-based compact/expanded decisions (9 new tests)
