...
| 3 | [03-cursor-file-reference-tracking](tasks/03-cursor-file-reference-tracking.md) | Not Started | - | 3-4h | `tui/widgets/log_view.rs`, `app/session.rs` |
...
| 6 | [06-osc8-hyperlink-rendering](tasks/06-osc8-hyperlink-rendering.md) | Not Started | 1, 2, 5 | 4-5h | `tui/hyperlinks.rs`, `tui/render.rs`, `config/types.rs` |
...
| Module | Purpose |
|--------|---------|
| `src/tui/hyperlinks.rs` | OSC 8 sequence generation, URL creation, terminal detection |
...
| Key | Action |
|-----|--------|
| `o` | Open file at cursor in configured editor |
