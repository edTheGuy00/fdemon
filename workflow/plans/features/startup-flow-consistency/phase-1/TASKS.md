...
|---|------|--------|------------|------------|---------|
| 1 | [01-add-message-variants](tasks/01-add-message-variants.md) | Done | - | 0.5h | `message.rs` |
| 2 | [02-add-update-action](tasks/02-add-update-action.md) | Done | 1 | 0.5h | `handler/mod.rs` |
| 3 | [03-add-handler-scaffolding](tasks/03-add-handler-scaffolding.md) | Done | 2 | 1-2h | `handler/update.rs` |
| 4 | [04-add-spawn-function](tasks/04-add-spawn-function.md) | Done | 3 | 2-3h | `tui/spawn.rs`, `tui/actions.rs` |

## Success Criteria

Phase 1 is complete when:

- [x] `Message::StartAutoLaunch` exists and compiles
- [x] `Message::AutoLaunchProgress` exists and compiles
- [x] `Message::AutoLaunchResult` exists and compiles
- [x] `UpdateAction::DiscoverDevicesAndAutoLaunch` exists
- [x] Handler dispatches to scaffolding functions (can log/no-op initially)
- [x] Spawn function structure is in place
