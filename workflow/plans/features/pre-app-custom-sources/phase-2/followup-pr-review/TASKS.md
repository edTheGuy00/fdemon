...
|---|------|--------|------------|----------|---------|
| 1 | [01-fix-branch-b-platform-guard](tasks/01-fix-branch-b-platform-guard.md) | Not Started | - | BUG | `handler/session.rs`, `handler/tests.rs` |
| 2 | [02-doc-and-cleanup](tasks/02-doc-and-cleanup.md) | Not Started | - | MINOR | `handler/mod.rs`, `example/app5/server/server.py` |

## Success Criteria

Followup is complete when:

- [ ] Issue 1: Branch B guard no longer blocks platform capture on Android/macOS/iOS with pre-app-only sources
- [ ] Issue 2: `SpawnPreAppSources.running_shared_names` doc comment accurately describes data flow
- [ ] Issue 3: Unused `import sys` removed from `server.py`
