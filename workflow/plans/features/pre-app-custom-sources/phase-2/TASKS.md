...
|---|------|--------|------------|---------|
| 1 | [01-config-shared-field](tasks/01-config-shared-field.md) | Done | - | `config/types.rs` |
| 2 | [02-shared-source-handle](tasks/02-shared-source-handle.md) | Done | - | `session/handle.rs`, `state.rs` |
| 3 | [03-message-variants](tasks/03-message-variants.md) | Done | - | `message.rs` |
| 4 | [04-tea-handlers](tasks/04-tea-handlers.md) | Done | 1, 2, 3 | `handler/update.rs` |
| 5 | [05-spawn-shared-pre-app](tasks/05-spawn-shared-pre-app.md) | Done | 1, 2, 3 | `actions/native_logs.rs`, `actions/mod.rs` |
| 6 | [06-spawn-shared-post-app](tasks/06-spawn-shared-post-app.md) | Done | 5 | `actions/native_logs.rs` |
| 7 | [07-pre-app-gate-skip](tasks/07-pre-app-gate-skip.md) | Done | 4, 5 | `handler/new_session/launch_context.rs`, `handler/update.rs` |
| 8 | [08-engine-shutdown](tasks/08-engine-shutdown.md) | Done | 2, 4 | `engine.rs` |
| 9 | [09-integration-tests](tasks/09-integration-tests.md) | Done | 4, 5, 6, 7, 8 | `handler/tests.rs` |
| 10 | [10-documentation](tasks/10-documentation.md) | Done | 1 | `docs/CONFIGURATION.md`, `docs/ARCHITECTURE.md` |
