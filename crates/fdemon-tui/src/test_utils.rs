...
pub fn create_test_state() -> fdemon_app::state::AppState {
...
pub fn create_test_state_with_name(name: &str) -> fdemon_app::state::AppState {
...
pub use fdemon_daemon::test_utils::{test_device, test_device_full, test_device_with_platform};
...
mod tests {
    ...
    fn test_create_test_state() {
        ...
        assert_eq!(state.ui_mode, fdemon_app::state::UiMode::Normal);
    }
